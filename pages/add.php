...
<section class="flex flex-col">
    <?php if(isset($_SESSION["loggedUser"]) && ($_SESSION["loggedUser"]["roles_id"] == "1" || $_SESSION["loggedUser"]["roles_id"] == "2")) : ?>
            ...
            <form action="addpost.php" method="POST" enctype="multipart/form-data" class="flex flex-col flex-nowrap gap-4">
                ...
                enctype="multipart/form-data" - Mendatory because there is a file input in my form 
                        ...
                        <input type="text" class="input" id="auteur" name="auteur" placeholder="Auteur" value="<?=  $_SESSION["loggedUser"]["name"]. " ". $_SESSION["loggedUser"]["surname"] ?>" />
                        </div>
                        <div class="flex-row-w">
                ...
                <div>
                    ...
                    <button class="btn size-fit self-center" type="submit">Envoyer</button>
            </form>
   ...
   <button class="btn btn-soft btn-secondary size-fit self-center mt-10"><a href="/blog/public/index.php">Retour à la page d'accueil</a></button>
