...
$sqlQueryAuteur = 'SELECT author, match_id, image FROM articles WHERE id = :id';
...
// Return false and exit the script
    ...
    $sqlQueryMatch = 'INSERT INTO matches(team1, team2, score, summary, location, date) VALUES (:team1, :team2, :score, :summary, :location, :date)';
